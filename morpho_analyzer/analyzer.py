...
import heapq
import collections
from morpho_analyzer import opencorpora_dict
...
class MorphAnalyzer(object):
    ...
    Create a :class:`MorphAnalyzer` object::
        ...
        >>> morph = morpho_analyzer.MorphAnalyzer()

    MorphAnalyzer uses dictionaries from ``morpho_analyzer-dicts`` package
    (which can be installed via ``pip install morpho_analyzer-dicts``).
    ...
    to :class:`morpho_analyzer.MorphAnalyzer` constructor::

        >>> morph = morpho_analyzer.MorphAnalyzer('/path/to/dictionaries') # doctest: +SKIP
    ...
    ``result_type=None`` to make analyzer return plain unwrapped tuples::
        ...
        >>> morph = morpho_analyzer.MorphAnalyzer(result_type=None)
    ...
    def choose_dictionary_path(cls, path=None):
        ...
        try:
            ...
            msg = ("Can't find dictionaries. "
                   ...
                   "or install 'morpho_analyzer-dicts' package, "
