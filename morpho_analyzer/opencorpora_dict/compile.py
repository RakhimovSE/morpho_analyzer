# -*- coding: utf-8 -*-
"""
:mod:`morpho_analyzer.opencorpora_dict.compile` is a
module for converting OpenCorpora dictionaries
to morpho_analyzer representation.
"""
...
from morpho_analyzer import dawg
from morpho_analyzer.constants import PARADIGM_PREFIXES, PREDICTION_PREFIXES
from morpho_analyzer.utils import longest_common_substring
...
def convert_to_morpho_analyzer(opencorpora_dict_path, out_path, overwrite=False,
                               prediction_options=None):
    """
    Convert a dictionary from OpenCorpora XML format to
    morpho_analyzer compacted format.
...
def _suffixes_prediction_data(words, popularity, gramtab, paradigms,
    ...
    # XXX: this uses approach different from m_analyzer 0.5.6;
