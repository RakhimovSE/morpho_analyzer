# -*- coding: utf-8 -*-
"""
:mod:`morpho_analyzer.opencorpora_dict.storage` is a
module for saving and loading morpho_analyzer dictionaries.
"""
...
def load_dict(path, gramtab_format='opencorpora-int'):
    """
    Load morpho_analyzer dictionary.
...
def save_compiled_dict(compiled_dict, out_path):
    ...
    meta = [
        ...
        ['morpho_analyzer_version', morpho_analyzer.__version__],
